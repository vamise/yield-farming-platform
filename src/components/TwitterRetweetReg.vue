      ...
      <div v-else-if="this.progression == 1" class="multistepmodal">
        <div class="steps">
                ...
                <div :class="this.twitterA ? 'notdone' : 'notdone' " >
                    ...
                    <span v-else class="span first"><img src="https://finance.fyfy.app/distant/check-one.png?t=1" alt=""></span>
                    <div>
                      <a href="https://twitter.com/fyfyio" target="_blank" @click="validateTwitterA()" >
                        <img src="@/assets/icons/twitter.svg" width="40" height="40" />
                      </a> Follow <b>Fyfy</b> on Twitter</div>
                </div>
                ...
                <div :class="this.telegramA ? 'notdone' : 'notdone' ">
                    ...
                    <div>
                      <a href="https://t.me/fyfyofficial" target="_blank" @click="validateTelegramA()" >
                        <img src="@/assets/icons/telegram.svg" width="40" height="40" />
                      </a>
                      Join <b>Fyfy</b> on Telegram</div>
                </div>


                <div v-if="this.farm.links.twitter" :class="this.twitterB ? 'notdone' : 'notdone' " >
                    <span v-if="!this.twitterB">3</span>
                    <span v-else class="span"><img src="https://finance.fyfy.app/distant/check-one.png?t=1" alt=""></span>
                    <div>
      ...
      <div v-else-if="this.progression == 2" class="multistepmodal">
        <div class="steps">
                ...
                <div :class="this.inputretwit ? 'notdone big' : 'notdone big' " >
                    ...
                    <span v-else class="span2 first"><img src="https://finance.fyfy.app/distant/check-one.png?t=1" alt=""></span>
                    <div>


                    <div class="inforetweet">Quote Retweet by tagging 3 friends 
and using the #Fyfy #Fertilizer</div>

                    <div>

                    <blockquote class="twitter-tweet"><p lang="en" dir="ltr">👨🏻‍🌾 Dear Fyfylians,<br><br>📣 We’re excited to announce our Farm Launcher’s hero feature. <br><br>🎉 Introducing a feature that celebrates DeFi innovation while rewarding farmers. <br><br>🤝 Meet <a href="https://twitter.com/hashtag/Fertilizer?src=hash&amp;ref_src=twsrc%5Etfw">#Fertilizer</a>🧪<a href="https://discord.gg/mFHvP2e8">https://discord.gg/mFHvP2e8</a></p>&mdash; Fyfy (@Fyfy) <a href="https://twitter.com/fyfyio/status/1443533161913372672?ref_src=twsrc%5Etfw">February 8, 2022</a></blockquote> <script src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
                    </div>
...
export default Vue.extend({
  ...
  methods: {
    async nextStep(){
      ...
      this.progression++;
      this.walletAddress = "https://api.finance.fyfy/fertilizer/project/?f=" + this.farm.slug + "&r=" + this.$accessor.wallet.address;


      if(this.progression == 3){ 
        let registerUrl = 'https://api.finance.fyfy/pfo/register/?spl=' + this.$accessor.wallet.address + '&farmId='+ this.farm.pfarmID;
