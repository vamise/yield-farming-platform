...
export default Vue.extend({
  ...
  methods: {
    ...
    placeOrder() {
      ...
      } else if ((this.endpoint === 'FyfyFinance Pool' || this.endpoint === 'Raydium Pool') && this.swaptype == 'single') {
      ...
      }else if(this.endpoint === 'FyfyFinance Pool' && this.swaptype == 'multi') {
